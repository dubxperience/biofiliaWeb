    ...
    <section className="instruction-container">
      {step === 1 && (
        <div className="step step-1">
          ...
          <img
            className="cacao-frente"
            src="/cacao/cacao-frente.png"
            alt="cacao-frente"
          />
          <svg
            width="251"
      ...
      {step === 2 && (
        <div className="step step-2">
          <div className="step-2-content">
            <h3>
              Responde cada pregunta <br />
              eligiendo una de dos opciones
            </h3>
            ...
            <h5>
              Solo una es correcta... ¡confía en tu intuición (y en el cacaito)!
            </h5>

            <button className="button-next" onClick={() => setStep(3)}>
              Empezar a jugar
            </button>
          </div>
          <img
            className="cacao-frente-2"
            src="/cacao/cacao-frente.png"
            alt="cacao-frente"
          />
          <svg
